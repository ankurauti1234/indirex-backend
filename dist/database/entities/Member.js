...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Household_1.Household, (household) => household.members, { onDelete: "CASCADE" }),
    (0, typeorm_1.JoinColumn)({ name: "household_id" }),
    __metadata("design:type", Household_1.Household)
], Member.prototype, "household", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: "member_code", type: "varchar", length: 10 }),
    __metadata("design:type", String)
